...
/**
 * native-image --initialize-at-run-time=java.security.SecureRandom -H:+ReportExceptionStackTraces --no-fallback -jar target/redkale-2.8.0-SNAPSHOT.jar
 *
 * @author zhangjx
 */
@Mojo(
...
public class RedkaleCompileMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            RedkaleClassLoader contextLoader =
                    new RedkaleClassLoader(urls, Thread.currentThread().getContextClassLoader());
            ...
            final File nativeImageDir = new File(
                    outputDirectory,
                    "META-INF" + File.separatorChar + "native-image"
                            + File.separatorChar + projectArtifact.getGroupId()
                            + File.separatorChar + projectArtifact.getArtifactId());
                ...
                try {
                    ...
                    reflectionMap.put(
                            ...
                            Utility.ofMap(
                                    ...
                                    "fields",
                                    Utility.ofArray(
                                            Utility.ofMap("name", "producerIndex", "allowUnsafeAccess", true))));
                    reflectionMap.put(
                            ...
                            Utility.ofMap(
                                    ...
                                    "fields",
                                    Utility.ofArray(
                                            Utility.ofMap("name", "producerLimit", "allowUnsafeAccess", true))));
                    reflectionMap.put(
                            ...
                            Utility.ofMap(
                                    ...
                                    "fields",
                                    Utility.ofArray(
                                            Utility.ofMap("name", "consumerIndex", "allowUnsafeAccess", true))));
                    reflectionMap.put(
                    ...
                    reflectionMap.put(
                            ...
                            Utility.ofMap(
                                    ...
                                    true,
                                    "methods",
                                    Utility.ofArray(Utility.ofMap("name", "<init>", "parameterTypes", new String[0]))));
                    reflectionMap.put(
                            "io.netty.buffer.AbstractByteBufAllocator",
                            Utility.ofMap(
                                    "name", "io.netty.buffer.AbstractByteBufAllocator", "allDeclaredMethods", true));
                    reflectionMap.put(
                            "io.netty.buffer.AdvancedLeakAwareByteBuf",
                            Utility.ofMap(
                                    "name", "io.netty.buffer.AdvancedLeakAwareByteBuf", "allDeclaredMethods", true));
                    reflectionMap.put(
            ...
            { // 反射写入文件
                ...
                Set<String> sysPropertyNames = Set.of(
                        "jdk.",
                        "path.",
                        "java.",
                        "file.",
